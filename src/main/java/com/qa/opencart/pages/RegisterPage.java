...
public class RegisterPage {
	...
	private By subscribeYes=By.xpath("//input[@type='submit' and @value='Continue']");
	...
	public String registerUser(String firstName, String lastName, String email, String telephone, String password, String subscribe)
	{
		...
		String userSucessRegMessg=eleUtil.waitForElementVisible(userRegSuccMessg, AppConstants.MEDIUM_DEFAULT_WAIT).getText();
		System.out.println(userSucessRegMessg);
