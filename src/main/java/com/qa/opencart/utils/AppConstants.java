...
public class AppConstants {
	...
	public static final List<String> EXP_ACC_HEADERS_LIST=Arrays.asList("My Account","My Orders","My Affiliate Account","Newsletter");
	public static final String LOGIN_ERROR_MESSAGE = " Warning: No match for E-Mail Address and/or Password.";
	public static final String USER_RESG_SUCESS_MESSAGE = "Your Account Has Been Created!";
